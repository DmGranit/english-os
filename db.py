...
-- C2: DNA-идеи как концепт-карточки
CREATE TABLE IF NOT EXISTS idea_ref (
...
_IDEA_SEED = [
    ("Communication", "Коммуникация",
     "Передача смысла, намерений и информации между людьми — говорить, писать, слушать, убеждать.",
     "Рус. «общение» звучит как процесс. Англ. Communication = направленный акт: у него есть "
     "отправитель, получатель и цель. Думай «что я хочу донести и зачем» — не «как поговорить»."),
    ("Movement", "Движение",
     "Физическое и метафорическое перемещение: прогресс, передача, смена направления.",
     "Рус. «двигаться» — про физику. Англ. Movement охватывает карьеру, проект, переговоры. "
     "Думай «что сдвигается/продвигается» — не только тело, но и ситуация."),
    ("Value", "Ценность",
     "Польза, стоимость, выгода — то, ради чего что-то делается или чего-то стоит.",
     "Рус. «ценность» — абстракция. Англ. Value всегда конкретна: для кого, сколько, в чём. "
     "Думай «кто получает выгоду» — тогда нужное слово найдётся само."),
    ("Knowledge", "Знание",
     "Знание, понимание, учёба, осознание — от факта до глубокого понимания.",
     "Рус. «знать» = иметь информацию. Англ. Knowledge различает know (факт), understand "
     "(смысл), realize (осознать впервые). Думай «на каком уровне знание» — глубина важна."),
    ("Exchange", "Обмен",
     "Взаимная передача: товаров, услуг, идей, ресурсов, информации.",
     "Рус. «обмен» звучит как бартер. Англ. Exchange — любая двусторонняя передача ценности. "
     "Думай «что идёт в обе стороны» — тогда слово точнее, чем give/get по отдельности."),
    ("Growth", "Рост",
     "Увеличение, развитие, масштабирование — личное и организационное.",
     "Рус. «рост» = физика/цифры. Англ. Growth включает потенциал и направление. "
     "Думай «рост к чему» — тогда grow, develop, scale дают разные оттенки."),
    ("Creation", "Создание",
     "Производство нового: идей, продуктов, решений, контента.",
     "Рус. «создать» — нейтральный глагол. Англ. разделяет create (с нуля), build (поэтапно), "
     "develop (разработать), design (с умыслом). Думай «как именно создаётся» — глагол уточнится."),
    ("Ownership", "Владение",
     "Собственность, ответственность, контроль над ресурсом или результатом.",
     "Рус. «владеть» = иметь юридически. Англ. Ownership = также «брать ответственность». "
     "Думай «кто несёт ответственность» — не только кто на документах."),
    ("Vision", "Видение",
     "Цель, стратегический образ будущего, долгосрочное намерение.",
     "Рус. «видение» — редкое слово. Англ. Vision — стандарт делового языка: куда компания/человек идёт. "
     "Думай «что мы хотим увидеть через 3–5 лет» — тогда vision, goal, target разложатся по местам."),
    ("Leadership", "Лидерство",
     "Руководство, влияние, вдохновение — ведение людей к цели.",
     "Рус. «руководство» = административная власть. Англ. Leadership = влияние без должности. "
     "Думай «кто задаёт направление» — не кто стоит выше по иерархии."),
    ("Trust", "Доверие",
     "Надёжность, честность, уверенность в другом человеке или системе.",
     "Рус. «доверие» — эмоция. Англ. Trust = доказанная надёжность + готовность на неё опереться. "
     "Думай «что именно доказано» — тогда trust, reliability, credibility дадут нужный оттенок."),
    ("Change", "Изменение",
     "Трансформация, адаптация, пересмотр — переход из одного состояния в другое.",
     "Рус. «изменить» — одно слово на всё. Англ. различает change (заменить), adjust (подстроить), "
     "transform (коренной перелом), adapt (приспособиться). Думай «насколько глубоко меняется»."),
    ("Decision", "Решение",
     "Выбор, принятие решения, приоритизация между альтернативами.",
     "Рус. «решение» — и answer, и decision. Англ. decision = выбор между вариантами; "
     "resolution = итог конфликта; solution = ответ на задачу. Думай «что именно выбирается»."),
    ("Health", "Здоровье / состояние",
     "Физическое и организационное благополучие, устойчивость, баланс.",
     "Рус. «здоровье» = про тело. Англ. Health шире: financial health, team health, work-life balance. "
     "Думай «что поддерживается в рабочем состоянии» — тело, проект или команда."),
    ("Protection", "Защита",
     "Безопасность, предотвращение риска, сохранение ценности.",
     "Рус. «защита» = оборона. Англ. Protection = также предупреждение и страховка. "
     "Думай «от чего и как» — protect (барьер), secure (закрепить), ensure (гарантировать)."),
    ("Investment", "Инвестиции",
     "Вложение ресурсов (деньги, время, усилия) ради будущей отдачи.",
     "Рус. «инвестиции» = финансы. Англ. Invest шире: invest time, invest in people. "
     "Думай «что вкладываешь и какую отдачу ждёшь» — даже в разговоре без денег."),
    ("Clarity", "Ясность",
     "Чёткость, понятность, отсутствие двусмысленности в словах и структурах.",
     "Рус. говорят «понятно» как оценку. Англ. Clarity — активная задача: сделать так, чтобы поняли. "
     "Думай «понял ли другой, а не сказал ли я» — тогда clarify, specify, simplify встанут на место."),
    ("Commitment", "Обязательство",
     "Верность слову, настойчивость, готовность довести до конца.",
     "Рус. «обязательство» = юридический термин. Англ. Commitment = внутренняя готовность держать курс. "
     "Думай «насколько человек внутренне готов» — не только что подписал."),
    ("Problem → Solution", "Проблема → Решение",
     "Цикл: обнаружить препятствие, понять причину, предложить ответ.",
     "Рус. «проблема» = негатив. Англ. Problem → Solution — нейтральный профессиональный цикл. "
...
def _seed_ideas(c):
    ...
    for idea, ru, description, thinking_pattern in _IDEA_SEED:
...
def idea_info(idea):
    ...
    with _conn() as c:
        r = c.execute(
            "SELECT idea, ru, description, thinking_pattern FROM idea_ref WHERE idea=?",
            (idea,)
        ).fetchone()
    return dict(r) if r else None
