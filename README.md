...
<!-- СКРИНШОТ: главный экран бота — приветствие с картой дня и клавиатурой -->
<p align="center"><img src="docs/screenshots/hero.png" width="420" alt="English OS — главный экран"></p>
...
<!-- СКРИНШОТ: карта дня в /start — «Сегодня: 🌅 ✅ · ☀️ — · 🎭 —» -->
<p align="center"><img src="docs/screenshots/day_map.png" width="420" alt="Карта дня"></p>
...
<!-- СКРИНШОТ: карточка повторения с кнопками «Показать ответ» / «Вспомнил / Забыл» -->
<p align="center"><img src="docs/screenshots/review_card.png" width="420" alt="Карточка повторения"></p>
...
<!-- СКРИНШОТ: фрагмент сценария + финальный ИТОГ сессии -->
<p align="center"><img src="docs/screenshots/scenario_summary.png" width="420" alt="Сценарий и итог сессии"></p>
...
<!-- СКРИНШОТ: /progress — список can-do + сводка пути -->
<p align="center"><img src="docs/screenshots/progress.png" width="420" alt="Прогресс"></p>
...
Ранний MVP в активной разработке. Доступ — по заявке у владельца. Открытые гипотезы и план их проверки — в [каноне](../docs/English_OS_Methodology_Canon.md), журнал решений — в [Decision Log](../docs/Decision_Log.md), внутренняя техдокументация — в [DEVELOPMENT.md](DEVELOPMENT.md).
